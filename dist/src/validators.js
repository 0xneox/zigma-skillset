...
export function validateWalletAddress(address) {
    if (!WALLET_ADDRESS_REGEX.test(address)) {
        throw new ValidationError('Invalid wallet address. Please provide a valid Ethereum address (0x...)');
    }
}
/**
 ...
 * Validate market ID
 */
export function validateMarketId(marketId) {
 ...
 */
export function validateMinEdge(minEdge) {
