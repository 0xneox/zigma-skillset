 ...
 */
export function formatSignal(signal: Signal, index: number): string {
  ...
  const liquidityStatus =
    signal.liquidity > LIQUIDITY.HIGH ? '✅' :
 ...
 */
export function formatAnalysis(analysis: MarketAnalysis): string {
  const actionEmoji =
    analysis.edge > 0.05 ? '🎯' :
 ...
 */
export function formatWalletAnalysis(wallet: WalletAnalysis): string {
 ...
 */
export function formatArbitrageOpportunity(opp: ArbitrageOpportunity, index: number): string {
  return `
 ...
 */
export function formatDailyPost(signals: Signal[]): string {
 ...
 */
export function formatOutcomePost(signal: Signal, outcome: 'WIN' | 'LOSS', pnl: number): string {
 ...
 */
export function formatLeaderboard(leaderboard: Array<{
  agent: string;
  pnl: number;
  winRate: number;
  trades: number;
 ...
 */
export function formatChallenge(agent: string, analysis: MarketAnalysis): string {
